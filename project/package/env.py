...
if __name__ == '__main__':
    ...
    DESCRIPTION = '\n'.join((
        ...
        f'',
        f'This tool manages a state. Every time the state changes, it is saved to file {STATE_FILEPATH}.',
    ...
    def default_open(args): 
        ...
        os.system(EDITOR.get()(VARS_FILEPATH))
    ...
    o  = sp.add_parser(P.OPEN,
                       ...
                       help   =f'open the variables file - located at {repr(VARS_FILEPATH)}')
    ...
    r  = sp.add_parser(P.RESET,
                       formatter_class=argparse.RawTextHelpFormatter,
                       help   =f'reset the state / remove the state file - located at {repr(STATE_FILEPATH)}')
